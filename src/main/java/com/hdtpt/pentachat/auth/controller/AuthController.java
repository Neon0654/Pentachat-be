...
public class AuthController {
    ...
    // --- Inject thêm Repository quản lý Token ---
    @Autowired
    ...
    public ResponseEntity<?> forgotPassword(@RequestBody Map<String, String> request) {
        ...
        tokenEntity.setExpiryDate(LocalDateTime.now().plusHours(24)); // Hết hạn sau 24h
        tokenRepository.save(tokenEntity);

        // Gửi Email chứa Link
        // LƯU Ý: Test trên máy bạn thì điền cứng email của bạn. Khi chạy thật thì dùng user.getEmail()
