package com.hdtpt.pentachat.users.controller;
...
import com.hdtpt.pentachat.users.service.UserService;
...
public class UserController {
    ...
    private String getAuthenticatedUser(String userId, String sessionId) {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse> getAllUsers(@RequestHeader("X-User-Id") String userId,
            @RequestHeader("X-Session-Id") String sessionId) {
        String authenticatedUserId = getAuthenticatedUser(userId, sessionId);
