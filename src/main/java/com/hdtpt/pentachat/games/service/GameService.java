...
public class GameService {
    ...
    public void createDummyGames() {
        if (gameRepository.count() == 0) {
            ...
            gameRepository.save(new Game(null, "Cờ Caro (X/O)", "Đấu trí 5 nước thắng, vừa chat vừa đánh cờ.",
                    "https://i.imgur.com/caro.png"));
            // Game 2: Rắn Săn Mồi - Đơn giản gây nghiện
            gameRepository.save(new Game(null, "Rắn Săn Mồi", "Điều khiển rắn ăn mồi, càng ăn càng dài.",
                    "https://i.imgur.com/snake.png"));

            // Game 3: Đào Vàng - Giải trí nhẹ nhàng
            gameRepository.save(new Game(null, "Đào Vàng", "Thả ngàm kéo vàng, kim cương và túi bí ẩn.",
                    "https://i.imgur.com/goldminer.png"));
